...
\input{pseudocodes/ex/bst-parent/insert}
...
\input{pseudocodes/ex/bst-parent/succ}

\input{pseudocodes/ex/bst-parent/parent}

\subparagraph{Costo di Parent} $O(h)$.

\input{pseudocodes/ex/bst-parent/pred}
