...
\input{pseudocodes/ex/insertion-sort-rec/insertion-sort-rec.tex}
\input{pseudocodes/ex/insertion-sort-rec/insert.tex}
...
\input{pseudocodes/ex/check-dup/check-dup.tex}
\input{pseudocodes/ex/check-dup/dmerge.tex}
...
\input{pseudocodes/ex/sum/sumB.tex}
...
\input{pseudocodes/ex/sum/sum.tex}
...
\end{gather*}
\input{pseudocodes/ex/sum/sumV.tex}
...
\input{pseudocodes/sorting/heap-sort/left}
\input{pseudocodes/sorting/heap-sort/right}
\input{pseudocodes/sorting/heap-sort/parent}
\input{pseudocodes/sorting/heap-sort/max-heapify}
\input{pseudocodes/sorting/heap-sort/build-max-heap}
\input{pseudocodes/sorting/heap-sort/heap-sort}

\subsection{Code con Priorità}
(Sezione \ref{codeconpriorita})
\input{pseudocodes/priority-queues/max}
\input{pseudocodes/priority-queues/extract-max}
...
\input{pseudocodes/priority-queues/delete-key}