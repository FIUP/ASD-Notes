...
\begin{itemize}
	...
	\begin{center}
		\begin{tikzpicture}[tree,sibling distance=10mm]
			\Tree
			[.$r$
				[.$T_1$ ]
				[.$T_2$ ]
...
\paragraph{Complessità} Nel caso peggiore, la complessità è l'altezza dell'albero $h$ ($O(h)$).
